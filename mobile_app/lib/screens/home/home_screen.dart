...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _statusBadge(String status) {
    ...
    // They are all displayed as "قيد المراجعة" until admin approval.
    if (s == 'قيد المراجعة' ||
        s == 'قيد التحليل' ||
        s == 'تم الفحص' ||
        s == 'مكتمل' ||
      ...
      // The reviewed status is shown only after admin approval.
  ...
  Widget _reportIcon(String status) {
    ...
    // Internal processing statuses use the same
    // "under review" appearance for the user.
    if (s == 'قيد المراجعة' ||
        s == 'قيد التحليل' ||
        s == 'تم الفحص' ||
        s == 'مكتمل' ||
      ...
      // The green reviewed icon is shown only after admin approval.
      bgColor = const Color(0xFFDCFCE7);
